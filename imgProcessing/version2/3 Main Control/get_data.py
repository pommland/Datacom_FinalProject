...
def extract_data(filename):
    ...
    frame_Q1 = f'{gray[20][60]}&{gray[20][70]}&{gray[30][60]}&{gray[30][70]}&a{q1_avg}'
    frame_Q2 = f'{gray[20][10]}&{gray[20][20]}&{gray[30][10]}&{gray[30][20]}&a{q2_avg}'
    frame_Q3 = f'{gray[60][20]}&{gray[60][30]}&{gray[70][20]}&{gray[70][30]}&a{q3_avg}'
    frame_Q4 = f'{gray[60][60]}&{gray[60][70]}&{gray[70][60]}&{gray[70][70]}&a{q4_avg}'
